...
const contractAddress = '0xc7DD11a24EDF74Dc72F3D653dceb05430Fa33d88'
...
export const useCryptoStore = defineStore('user', () => {
    ...
    async function wave(messageInput: string) {
        setLoader(true)
        try {
    ...
    async function getAllWaves() {
        ...
        try {
            ...
            if (ethereum) {
                ...
                waves.forEach((wave: { timestamp: number; waver: any; message: any }) => {
